...
open_file = open("pickled_algos/PolySVC_classifier.pickle","rb")
PolySVC_classifier = pickle.load(open_file)
open_file.close()

open_file = open("pickled_algos/RbfSVC_classifier.pickle","rb")
RbfSVC_classifier = pickle.load(open_file)
open_file.close()

open_file = open("pickled_algos/Weighted_LogisticRegression_classifier.pickle","rb")
Weighted_LogisticRegression_classifier = pickle.load(open_file)
open_file.close()

open_file = open("pickled_algos/MLP_classifier.pickle", "rb")
...
for company in company_list:
  ...
  scored_name = 'SentimentNews/Abnormal_' + company + '_News.csv'
